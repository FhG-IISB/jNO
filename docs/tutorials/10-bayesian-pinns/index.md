...
Eleven worked examples of Bayesian Physics-Informed Neural Networks
...
chosen subset of a model's parameter pytree; [Tutorial 11](./pathfinder-init.md)
exposes the *logdensity-aware initializer* hook on `.initialize()`,
landing **pathfinder** (Zhang et al. 2022) as a warm-start for any
HMC-family chain — the same extension point future Laplace / SVGD
initializers will plug into.
